function [T,Uinit,orth_obj, recon_obj,tim] = tucker_als_time(X,R,varargin)
...
reschangetol = params.Results.tol;
maxiters = params.Results.maxiters;
dimorder = params.Results.dimorder;
init = params.Results.init;
printitn = params.Results.printitn;

normresidual_old = inf;
...
if printitn > 0
    fprintf('\nTucker Alternating Least-Squares with time:\n');
end
...
for iter = 1:maxiters
    ...
    if mod(iter,printitn)==0
        fprintf(' Iter %2d: fit = %e fitdelta = %7.1e time = %7.1e\n', iter, fit, fitchange, t);
    end 
